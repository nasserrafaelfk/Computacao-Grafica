...
#define alt_tiro_inimigo 2.5
#define larg_tiro_inimigo 2.5
...
#define DELAY_TIRO_INIMIGO 20

#define TIPOS_INIMIGOS 4

#define tiros_param 1
...
signed short int flag_tiro_inimigo = 0;
